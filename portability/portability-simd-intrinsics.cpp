...
// Finds SIMD intrinsics calls and suggests std::experimental::simd (P0214)
// alternatives. If the option Suggest is set to non-zero, the check suggests an
// alternative: operator+ on std::experimental::simd objects.
//
...
// can be unified.
//
// Refer to P0214 for introduction and motivation for the data-parallel standard
// library.
