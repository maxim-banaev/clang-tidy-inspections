...
// This check looks for procedures (functions returning no value) with return statements at the end of the function.
// Such return statements are redundant.
//
...
namespace readability {
    namespace redundant_control_flow {
        extern void g() {}
